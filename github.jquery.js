		...
		getRepos(function(repos) 
		{
			getCommits(repos, function(commits) 
			{
				var html = '<table class="table table-bordered table-striped table-condensed">'
						  +'<tr><td colspan="3"><i class="icon-github-1" style="position:relative;top:3px"></i> &nbsp;<small>GitHub Activity</small></td></tr>';
				...
				for(var i = 0; i < commits.length; i++) {
					...
					html += '<td style="border-left:0;text-align:right">'
							+ '<a href="'+commit.url+'" target="_blank"><span class="badge badge-inverse" style="font-weight:regular">'
